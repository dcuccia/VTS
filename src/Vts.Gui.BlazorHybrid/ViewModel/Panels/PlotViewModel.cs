...
namespace Vts.Gui.BlazorHybrid.ViewModel
{
    ...
    public class PlotViewModel : BindableObject
    {
        ...
        private void Plot_DuplicateWindow_Executed(object sender, EventArgs e)
        {
            var vm = Clone();
            vm.UpdatePlotSeries();
        ...
        /// <param name="e"></param>
        private void Plot_ExportDataToText_Executed(object sender, EventArgs e)
        {
        ...
        private void Plot_Cleared(object sender, EventArgs e)
        {
            ClearPlot();
            UpdatePlotSeries();
        }

        private void Plot_ClearedSingle(object sender, EventArgs e)
        {
            ClearPlotSingle();
            UpdatePlotSeries();
        }
