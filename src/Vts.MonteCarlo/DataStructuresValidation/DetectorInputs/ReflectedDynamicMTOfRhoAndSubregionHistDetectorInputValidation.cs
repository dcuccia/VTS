...
namespace Vts.MonteCarlo
{
    ...
    /// </summary>
    public class ReflectedDynamicMTOfRhoAndSubregionHistDetectorInputValidation
    {
        /// <summary>
        ...
        public static ValidationResult ValidateInput(IDetectorInput input, int tissueRegionCount)
        {
            ...
            if (((dynamic)input).BloodVolumeFraction.Count != tissueRegionCount)
            {
                return new ValidationResult(
                    false,
                    "ReflectedDynamicMTOfRhoAndSubregionHistDetectorInput: blood volume fraction list length needs to match number of tissue subregions",
                    "Modify list of blood volume fraction to agree with tissue regions");
            }
            return new ValidationResult(
                true,
                "ReflectedDynamicMTOfRhoAndSubregionHistDetectorInput: blood volume fraction list agrees with number of tissue regions");
        }
    }
}
